...
public class MarvelPresenter implements MarvelInterface.Presenter{
    ...
    private static final String first = "01fdd5eea27a50607e18d9dc5864933e";
    private static final String second = "02ef461fb953d3750f0e60e00bf7d2f8b731462d";
    ...
    public void fetchData() {
        ...
        String hash = DigestUtils.md5Hex(ts + second + first);
        retrofit.create(MarvelClient.class).getRepos(limit, ts, first, hash)
